...
export default function SideNavbar() {
  ...
  return (
    <Box sx={{position:'fixed' ,width:'15vw', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height:'100vh', borderRight: 'solid 2px #d2d2d2'}}>
      ...
      {/* image */}
      <Box sx={{ display: 'flex', flexDirection: 'column' ,gap: '1rem', alignItems: 'center', justifySelf: 'flex-start', marginTop:'2rem', paddingBottom:'5rem' }}>
        <img src={img} alt="logo" className="w-60" />
        {/* <Typography level="h2" sx={{fontWeight: 'bold', fontSize: '3rem'}}>Groupe Diar Dzair</Typography> */}
      </Box>
      ...
      <Box sx={{  marginTop: '0.5rem', maxHeight: '70vh', overflow: 'auto' }}>
            ...
            <Box sx={{ 
              ...
              <Box>
                ...
                {Number(customer.customer_frais_virement		) > 0 && (
                  <Typography level="body2" fontWeight="bold">Virement: {Number(customer.customer_frais_virement			)} DA</Typography>
                )}


                {Number(customer.customer_frais_cash		) > 0 && (
                  <Typography level="body2" fontWeight="bold">Cash: {Number(customer.customer_frais_cash	)} DA </Typography>
                )}
        ...
        <>
          ...
          <Button 
            ...
            variant="contained"
            color={"error"}
            sx={{ alignSelf: 'center', fontSize:'1.2rem', padding:'0.5rem 1.7rem', textTransform: 'none'}}
          >
            Fermer
          </Button>
        </>
