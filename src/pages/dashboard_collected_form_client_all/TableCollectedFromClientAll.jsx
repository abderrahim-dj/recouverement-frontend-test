...
import filterUserCollectedMoneyAll from '../../services/filterUserCollectedMoneyAll';
...
export default function TableCollectedFromClientAll(){
  ...
  const fetchData = useCallback(async (pageIndex, pageSize, filterSearch) => {
    ...
    try {
      ...
      const response = await filterUserCollectedMoneyAll({
