...
import getListOfCustomerApproved from '../../services/getListOfCustomerApproved';
...
export default function TableCustomerApproved(){
  ...
  const fetchData = useCallback(async (pageIndex, pageSize, filterSearch) => {
    ...
    try {
      ...
      const response = await getListOfCustomerApproved({
 ...
 */  
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: 'customer_validated_date',
        header: 'Validation depuis',
        size: 200,
      },
      {
        accessorKey: 'customer_validated_by_full_name',
        header: 'Validé par',
        size: 'auto',
      },
      {
