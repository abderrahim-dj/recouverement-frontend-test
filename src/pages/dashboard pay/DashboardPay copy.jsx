//this is the old version of the dashboard pay page
        ...
        >
          ...
          */}
          ...
          {customerSelectedData && isMobile && (
            ...
            <Box >
              <Paper elevation={3} sx={{ p: 4, borderRadius: 3, minWidth: '100%', mx: isMobile ? 0 : 1, my:isMobile ? 0 :1 }}>
          ...
          */
          ...
          {/* this is was in the old version */}
          {/* what he will pay the appel personel, service, liverison, ramasage */}
          {/* 
          <Controller
            name="pay_what"
            control={control}
            rules={{ required: "Sélectionnez ce que l'utilisateur paie" }}
            render={({ field, fieldState }) => (
              <>
                <Select
                  value={field.value}
                  onChange={(_, newValue) => field.onChange(newValue)}
                  placeholder="Sélectionnez ce que l'utilisateur paie"
                  sx={{ 
                    bgcolor: 'white',
                    '& .MuiSelect-select': {
                      paddingY:'2rem'
